export const arrowLeftIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" fill="none">
    <path
      fill="currentColor"
      d="M10.5 13.78a.495.495 0 0 1-.354-.147L5.8 9.287a1.827 1.827 0 0 1 0-2.574l4.346-4.346a.503.503 0 0 1 .707 0 .503.503 0 0 1 0 .706L6.506 7.42a.82.82 0 0 0 0 1.16l4.347 4.347a.503.503 0 0 1 0 .706.524.524 0 0 1-.354.147Z"
    />
  </svg>
);

export const arrowLeftDesktopIcon = (
...
export const lineChartDesktopIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none">
    <path
      fill="currentColor"
...
export const homeWifiDesktopIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none">
    <path
      fill="currentColor"
...
export const menuBoardDesktopIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none">
    <path
      fill="currentColor"
